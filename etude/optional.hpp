      ...
      >
  {
   ...
   private:
    ...
    template< class U,
      ...
      >::type
    >
    bool greater_eq_( U const& x ) const {
      return *this ? ( x <= this->get() ) : false;
    }
    // 参照
    template< class U,
